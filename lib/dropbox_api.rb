...
require 'dropbox_api/results/delete_batch/async_job'
require 'dropbox_api/results/delete_batch/result_data'
require 'dropbox_api/results/delete_batch/result_entry'
require 'dropbox_api/results/delete_batch/result'
require 'dropbox_api/results/delete_batch_job_status'
require 'dropbox_api/results/delete_batch_launch'
...
require 'dropbox_api/results/file_properties_template.rb'
require 'dropbox_api/results/file_properties_template_list.rb'
...
require 'dropbox_api/endpoints/property_groups_formatter'
require 'dropbox_api/endpoints/file_properties/add'
require 'dropbox_api/endpoints/file_properties/overwrite'
require 'dropbox_api/endpoints/file_properties/remove'
require 'dropbox_api/endpoints/file_properties/templates/add_for_user'
require 'dropbox_api/endpoints/file_properties/templates/get_for_user'
require 'dropbox_api/endpoints/file_properties/templates/list_for_user'
require 'dropbox_api/endpoints/file_properties/templates/remove_for_user'
require 'dropbox_api/endpoints/file_properties/templates/update_for_user'
require 'dropbox_api/endpoints/file_properties/update'
